...
OUT="$(cd "$(dirname "$0")/.." && pwd)/public/images/trips/london"
mkdir -p "$OUT"
UA="TFamilyGame/0.1 (educational kids game; image sourcing script)"
API="https://commons.wikimedia.org/w/api.php"

SLUGS=(skyline tower museum tube greenwich outro)
QUERIES=(
  "Palace of Westminster Big Ben Thames"
  "Tower of London White Tower"
  "British Museum Great Court"
  "London Underground train platform"
...
{
  echo "# Image credits — London trip"
  echo
