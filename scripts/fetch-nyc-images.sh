...
OUT="$(cd "$(dirname "$0")/.." && pwd)/public/images/trips/nyc"
mkdir -p "$OUT"
UA="TFamilyGame/0.1 (educational kids game; image sourcing script)"
API="https://commons.wikimedia.org/w/api.php"

SLUGS=(skyline liberty central-park subway queens-food broadway outro)
QUERIES=(
  "Lower Manhattan skyline panorama"
  "Statue of Liberty Liberty Island"
  "Central Park lake skyline Manhattan"
  "New York City subway train platform"
  "Flushing Queens street food market"
  "Times Square Broadway theater marquee night"
  "aerial view New York City Manhattan from airplane"
)
...
{
  echo "# Image credits — New York City trip"
  echo
